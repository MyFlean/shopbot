...
This module contains stateless helper functions that were previously private
methods on ``ShoppingBotCore``. Extracting them here keeps the core class
focused on high-level flow control, while making the helpers easier to
unit‑test and reuse elsewhere in the code‑base.
"""
